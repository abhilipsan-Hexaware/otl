...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetmssql.Api.Filters;
using dotnetmssql.Business.Installer;
...
namespace dotnetmssql.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetmssql API", Version = version + "-" + branch});
            });
