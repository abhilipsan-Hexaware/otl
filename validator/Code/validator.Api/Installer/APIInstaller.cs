...
using ElmahCore.Mvc;
using ElmahCore;
using validator.Api.Filters;
using validator.BusinessServices.Installer;
...
namespace validator.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "validator API", Version = version + "-" + branch});
            });
