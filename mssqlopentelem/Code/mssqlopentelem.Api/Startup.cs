using mssqlopentelem.Api.Installer;
using mssqlopentelem.Api.Middleware;
using mssqlopentelem.Data.Repositories;
...
using mssqlopentelem.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
    {
       public Startup(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "mssqlopentelem V1");
            });
