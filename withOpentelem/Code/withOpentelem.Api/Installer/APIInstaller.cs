...
using ElmahCore.Mvc;
using ElmahCore;
using withOpentelem.Api.Filters;
using withOpentelem.Business.Installer;
...
namespace withOpentelem.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "withOpentelem API", Version = version + "-" + branch});
            });
