using withOpentelem.Api.Installer;
using withOpentelem.Api.Middleware;
using withOpentelem.Data.Repositories;
...
using withOpentelem.Api.Opentelemetry;
using OpenTelemetry;
    ...
    public class Startup
    {
       public Startup(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "withOpentelem V1");
            });
